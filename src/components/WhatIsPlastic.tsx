...
const timeline = [
  { year: "1855", text: "A Parkesine foi criada por Alexander Parkes e é considerada um dos primeiros plásticos semissintéticos." },
      ...
      <div className="container mx-auto max-w-5xl">
        <FadeInSection>
          ...
          <p className="text-muted-foreground text-justify mx-auto mb-12 text-lg">
            Os plásticos são polímeros produzidos a partir do petróleo. Um exemplo é o PET, criado em 1941, que se tornou muito utilizado em embalagens por ser leve, resistente e transparente. A partir da década de 1980, sua produção cresceu rapidamente, especialmente para bebidas e alimentos.
          </p>
        </FadeInSection>
        ...
        <FadeInSection delay={0.2}>
          ...
          <div className="relative">
            <div className="absolute left-4 md:left-[49%] top-0 bottom-0 w-0.5 bg-border md:-translate-x-px" />
            {timeline.map((item, i) => (
              <div
                key={item.year}
              ...
              >
                ...
                <div className="absolute left-4 md:left-[49%] w-4 h-4 rounded-full bg-accent border-4 border-background -translate-x-1/2 mt-1.5 z-10" />
